...
public class DriverMaster {
	...
	int driverCategory=0;
	ArrayList<TravelMaster> bookingQueue = new ArrayList<>();
	String mobileOperator;
	
	Date locationUpdateTime;
	...
	public ArrayList<TravelMaster> getBookingQueue() {
		return bookingQueue;
	}
	public void setBookingQueue(TravelMaster bookingQueueTMEntry) {
		this.bookingQueue.add(bookingQueueTMEntry);
	}
	...
	public String getCurrLongt() {
		return currLongt;
	}

	public void setCurrLongt(String currLongt) {
		this.currLongt = currLongt;
	}
